...
###################################### changed a little #############################################
    ...
    def handle_action(self, game: Game, direction) -> None:
        """
        Handle the fire action for a crossbow.
        
        If the user presses, the directions of keyboard for fire take the
        following actions:`
        \\begin{enumerate}
        \\item Ensure player has a weapon that is active, i.e. a crossbow,
               if they do not hold a crossbow or crossbow is 'Deactivated',
               do nothing.
        ...
        Parameters:
            game: The game that is currently being played.
            direction: The directions of keyboard pressed.
        """
        player = game.get_player()
        ...
        # Ensure player has a weapon that is active.
        for inventory in inventory.get_items():
            if isinstance(inventory, Crossbow) and inventory.is_active():
